...
public class BWEARResourceImportAllMojoTest extends AbstractMojoTestCase{
	...
	@Test
	public void testExecuteNotProfileparameter() {
		File profile = getTestFile( "src/test/resources/unit/BWEARResourceImportAllNotProfileParameterMojo/META-INF/DESA.substvar.backup" );
		profile.deleteOnExit();
		File profile2 = getTestFile( "src/test/resources/unit/BWEARResourceImportAllNotProfileParameterMojo/META-INF/INT.substvar.backup" );
		profile2.deleteOnExit();
		File pom = getTestFile( "src/test/resources/unit/BWEARResourceImportAllNotProfileParameterMojo/pom.xml" );
		//assertNotNull( pom );
		assertTrue( pom.exists() );
	...
	@Test
	public void testExecuteWithoutResourcesFolders() {

		File pom = getTestFile( "src/test/resources/unit/BWEARResourceImportAllWithoutResourcesFoldersMojo/pom.xml" );
		//assertNotNull( pom );
		assertTrue( pom.exists() );
		...
		try {
			...
			assertNotNull( myMojo );
			myMojo.execute();
			File profile = getTestFile( "src/test/resources/unit/BWEARResourceImportAllWithoutResourcesFoldersMojo/MATEA-INF/perro.substvar" );
